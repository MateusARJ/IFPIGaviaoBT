      ...
      <View style={styles.cabecalhoContainer}>
        <SafeAreaView edges={["top"]}>
          <View style={styles.cabecalhoLinha}>
            ...
            <Text style={styles.tituloHeader}>{state.nomeCategoria}</Text>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              ...
              onPress={() => actions.selecionarProduto(item.id)}
            >
              ...
              {/* Informações Centrais: Nome e Preço Formatado pela Entidade */}
              <View style={styles.infoContainer}>
                <Text style={styles.nomeItem}>{item.nome}</Text>
                <Text style={styles.precoItem}>{item.precoFormatado}</Text>
              </View>
